            ...
            <!--  <input type="hidden" name="Vendor_Id">-->
              ...
              <div class="col-sm-3"> 
                        ...
                        <label for="Bill Id">Bill Id:</label><input class="form-control" type="text" name="Bill_Id">
                             ...
                             <div class="col-sm-3">
<label for="Customer_No">Customer_No:</label><select class="form-control" name="Customer_Contact_No"><option value=""></option>
<?php
require("connection.php");
$sql2 = "SELECT Customer_Contact_No FROM customer";
$res = mysqli_query($conn, $sql2);
while($a=mysqli_fetch_assoc($res))
{
  $Customer_Contact_No=$a['Customer_Contact_No'];
  echo"<option>$a[Customer_Contact_No]</option>";
}
            ?>
 </select>                             </div>
                                <div class="col-sm-3">
