...
<div class="well">
 ...
 <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <h4>Enter Code:<input type="text" name="Customer_Contact_No">&nbsp
            <input class="btn btn-primary" type="submit" name="submit2" value="Enter" id="button4"></h4>
...
if (isset($_POST["submit2"]))
{
 ...
 require("connection.php");
//$sql2 = "SELECT id,Name,Code,Size,Category,Selling_price,Buying_Price FROM product2 where Code='$Code'";
 $sql2 = "SELECT * FROM customer where Customer_Contact_No='$Customer_Contact_No'";
$res = mysqli_query($conn, $sql2);
while($a=mysqli_fetch_assoc($res))
{
    ...
    $Customer_Email=$a['Customer_Email'];
           ...
           <!-- <input class="btn btn-primary" type="submit" value="New Customer" id="button3"></h4> -->
              ...
              <form class="form-horizontal" method="post" action="customer_insert.php">
                        ...
                        <div class="row">
                        <div class="col-sm-3">
                        <label for="Customer_Name">Name</label><input class="form-control" type="text" name="Customer_Name" value="<?php echo $Customer_Name;?>">
                        </div>
                        <div class="col-sm-3">
                        <label for="Customer_Contact_No">Contact_No</label><input class="form-control" type="text" name="Customer_Contact_No" value="<?php echo $Customer_Contact_No;?>">
                        </div>
                        <div class="col-sm-3">
                        <label for="Customer_Email">Email</label><input class="form-control" type="text" name="Customer_Email" value="<?php echo $Customer_Email;?>">
                        </div>
                        </div>
                        <br>
                        <div class="row">
