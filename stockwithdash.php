...
<div>
 ...
 <div class="head">
     ...
     <div class="well">
       <div>
                           <table class="table table-bordered" cellpadding="4" cellspacing="4" border="1" class="display" id="myTable">
                    <thead>
                         <tr>
                            <th>Code</th>
                            <th>Product Name</th>
...
while($a=mysqli_fetch_assoc($res))
{
 ...
 ?>
 <tbody>
<tr <?php echo ($Product_Quantity < 0 ? "class='isLess'" : ""); ?> >
 <?php
 ...
 <td>$a[Product_Category]</td>
  <td>$a[Product_Subcategory]</td>
  <td>$a[Product_Brand]</td>
