...
<?php
 ...
 <div class="well" id="tg3" >
               <form class="form-horizontal" method="POST" action="bill_insertforfinal.php" enctype="multipart/form-data">
                            <div class="row">
...
?>
                        ...
                        <label for="Bill No">Bill No:</label><input class="form-control" type="text" name="Bill_No" value="<?php
                     echo date('y').date('m').date('d').$a['Customer_Id'];
                    ?>">
                             </div>
                             <div class="col-sm-3">
<label for="Customer_No">Customer_No:</label><input class="form-control" type="text" name="Customer_Contact_No" value="<?php echo $a['Customer_Contact_No']; ?>">    
                             </div>
                             <div class="col-sm-3">
<label for="Customer_Name">Customer_Name:</label><input class="form-control" type="text" name="Customer_Name" value="<?php echo $a['Customer_Name']; ?>"> <?php }} ?>   
                             </div>
